...
import { AccordeonBlock } from "accordeon/app/lib/blocks"
...
export class Block extends React.PureComponent<{}, {}>{
    state: TableReactState;
    constructor(props) {
        super(props)
        this.state = new TableReactState(new Provider());
    }
        ...
        return (
            <div className="project-wrapper">
                ...
                <div className="main-content">
                    <div className="main-content-left-holder">
                        <div className="main-content-left-holder--inner">
                            <div className="main-content-title">{this.state.dict.PageTitle}</div>
                            <div className="main-content-elements">
                                ...
                                <div>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is pleasure, but because those who do not know how to pursue pleasure rationally encounter con</div>
                                <div>rationally encounter consequences that are extremely painful. Nor again is there anyone who loves or pursues or desires to obtain pain of itself, because it is pain, but because occasionally circumstances occur in which toil and pain can procure him some great pleasure. To take a trivial example, which of us eve</div>
